...
package com.tazzix.wear.salah.tile

import androidx.wear.tiles.*
import androidx.wear.tiles.LayoutElementBuilders.HORIZONTAL_ALIGN_CENTER
import androidx.wear.tiles.TileBuilders.Tile
import com.tazzix.wear.salah.SalahActivity
import com.tazzix.wear.salah.data.LocationViewModel
import com.tazzix.wear.salah.kt.*
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.withContext

class SalahTileProviderService : CoroutinesTileProviderService() {
                            ...
                            column {
                                ...
                                setModifiers(
                                    modifiers {
                                        ...
                                        setClickable(
                                            activityClickable(
                                                this@SalahTileProviderService.packageName,
                                                SalahActivity::class.java.name
                                            )
                                        )
                                    }
                                )
