...
class ConfigAsrCalcActivity : FragmentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val methods = resources.getStringArray(R.array.array_asrcalcs)
        ...
        recyclerView.adapter = MenuAdapter(this, R.layout.notitle_item, menuItems, object: MenuAdapter.AdapterCallback {
            override fun onItemClicked(menuPosition: Int?) {
                ...
                sharedPreferences.edit().putInt("ASR_CALC", menuPosition!!).apply()
                finish()
            }
        })
    }
